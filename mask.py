    ...
    with open(input_file) as f:
        with open(output_file, mode='w') as fo:
            ...
            for line in f.readlines():
                error += 1
                # print("mask(line.strip())", mask(line.strip()))
...
input_files = glob.glob("/Users/t_kajiura/Git/add_training/input_file/prog*.txt")
for input_file in tqdm(input_files):
    print(input_file)
    read_txt(input_file, output_file='prog-wiki_out.tsv')
